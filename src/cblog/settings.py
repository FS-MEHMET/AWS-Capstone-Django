...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name='/fsmehmet/capstone/username')
    password_param = ssm.get_parameter(Name="/fsmehmet/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'capstone-rds.cql2gvxzwguw.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'capstone-fsm-static' # please enter your s3 bucket name
